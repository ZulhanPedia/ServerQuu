...
// Penambahan log dengan proteksi otomatis jika array logs kosong/undefined
...
app.post('/api/upload/init', async (req, res) => {
    const { name, size, targetEmail } = req.body;
    ...
    // Jika user mengunci akun target secara manual, utamakan akun tersebut. Jika otomatis, gunakan pre-flight resolver
    let targetAccount = null;
...
<body class="text-slate-800 antialiased min-h-screen flex flex-col justify-between">
    ...
    <div id="mainDashboard" class="hidden flex-grow pb-12">
            ...
            <div class="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <div class="flex flex-col items-end gap-1">
                    <span class="inline-flex items-center gap-1 bg-sky-50 text-sky-700 px-2.5 py-0.5 rounded-full text-[10px] font-semibold border border-sky-100/30">
                        <span class="w-1 h-1 bg-sky-500 rounded-full animate-pulse"></span>
        ...
        <main class="max-w-6xl mx-auto px-4 mt-8">
            ...
            <div class="bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 custom-shadow">
                ...
                <!-- TAB UPLOAD (INTERACTIVE FOLDER SELECTOR & CREATOR) -->
                <div id="tab-upload" class="tab-content hidden">
                    ...
                    <form onsubmit="handleUpload(event)" class="space-y-6">
                        ...
                        <!-- PANEL PILIH AKUN & FOLDER INTERAKTIF -->
                ...
                <!-- TAB EXPLORER (DENGAN BAR PENCARIAN MODERN & KOLOM FOLDER) -->
    ...
    <script>
        ...
        // Global cache of accounts for dropdown usage
        ...
        // Sinkronisasi daftar akun pada tab upload dropdown
        ...
        // Handler perubahan dropdown akun di tab upload untuk load folder yang sesuai
        ...
        // Popup Input Pembuatan Folder Baru secara instan
        function promptCreateFolder() {
            ...
            .then(d => {
                ...
                if (d.success) {
                    ...
                    // Tambahkan ke dropdown dan langsung pilih folder baru tersebut
        ...
        // Variabel global untuk menyimpan data berkas demi pencarian instan klien
        window.allFiles = [];
        ...
        // Fungsi Pencarian / Filter Berkas Virtual Instan
        function filterFiles() {
            const query = document.getElementById("searchInput").value.toLowerCase().trim();
            const filtered = window.allFiles.filter(f => 
        ...
        // Cek target akun secara dinamis begitu berkas terpilih jika akun diatur "Otomatis"
                ...
                if (select.value === "auto") {
                    ...
                    .then(d => {
                        if (d.success) {
                            ...
                            // Memuat folder akun otomatis tersebut agar user bisa memilih folder sebelum mengupload!
                            folderSelect.disabled = false;
                            btnCreateFolder.disabled = false;
                            folderSelect.innerHTML = '<option value="">Memuat folder...</option>';
        ...
        // --- TEKNOLOGI ULTRA-SPEED: CLIENT-SIDE DIRECT UPLOAD KE API GOOGLE DRIVE DENGAN SELEKTOR FOLDER ---
        function handleUpload(e) {
            ...
            fetch('/api/upload/init', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ name: file.name, size: file.size, targetEmail: accSelect.value })
            })
            .then(res => {
            ...
            .then(data => {
                ...
                if (data.simulated) {
                    ...
                    fd.append("folderName", selectedFolderId); // Id = sub-direktori nama folder
                ...
                // KASUS B: JALUR CEPAT (Akun Live) - Upload langsung dari browser ke API Google Drive dengan parents folder
                ...
                // Jika folder terpilih tidak di root, masukkan ke parameter parents
                if (selectedFolderId) {
                ...
                xhr.addEventListener('load', () => {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        ...
                        // Kirim konfirmasi akhir ke server agar tercatat ke db.json
